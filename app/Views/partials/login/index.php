...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
     <link rel="shortcut icon" href="<?php echo base_url('') ?>/images/logo_bolang.png">
    <!-- Page Title  -->
                            ...
                            <div class="card-inner card-inner-lg cs-box-shadow">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content" style="display:flex;justify-content: center;">
                                        ...
                                        <img class="logo-dark logo-img logo-img-lg" style="width: 150px;" src="<?php echo base_url('') ?>/images/logo_bolang.png" srcset="<?php base_url('') ?>/images/logo_bolang.png 2x" alt="logo-dark">
                                   ...
                                   <?php echo form_open('AdminSignin', 'class="form-border"') ?>
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input name="email" type="text" class="form-control form-control-lg" id="default-01" placeholder="Enter your email address or username" value="<?php echo set_value('email') ?>">
                                             <?php
                                           if(isset($validation)){
                                                              // print_r($validation);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input name="password" type="password" class="form-control form-control-lg" id="password" placeholder="Enter your passcode" value="<?php echo set_value('password') ?>">
                                             <?php
                                           if(isset($validation)){
                                                              // print_r($validation);
